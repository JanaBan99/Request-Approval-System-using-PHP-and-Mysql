...
<body>
	<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
		<div class="container">
			...
			<a href="index.php" class="navbar-brand mr-3">Request - Approval System</a>
	...
	<header id="main-header" class="bg-danger py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-user-secret"></i>HR Login</h1>
				</div>
			</div>
		</div>
	</header>
...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$sql = "SELECT *  FROM hr WHERE email = '$user' AND password = '$password'";
